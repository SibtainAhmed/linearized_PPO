...
accelerate launch --main_process_port=29525 \
    ...
    --output_dir=output_tox_datainf_identity_2.7b_bfloat16_kl-0.04_val-1024_seed-22 \
    --init_kl_coef=0.04 --steps=200 \
    --min_length=20 \
    --wandb_project="ppo-detox" \
    --run_name="datainf-identity-2.7b-bfloat16-kl-0.04-val-1024_seed-22" \
    --datainf_identity \
    --datainf_percentile=2.0 \
    --datainf_eps=1e-8 \
    --val_loss_type="seqloss-lastadv" \
    --gen_data_dir="gen_tox_datainf_identity_2.7b_bfloat16_kl-0.04_val-1024_seed-22"
